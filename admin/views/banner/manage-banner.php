              ...
              <div id="sidemenu-include">
               ...
               <div class="col m12 s12 l9">
                  <div class="main-bar">
                    ...
                    <div class="row">
                                <div class="col 12 m6">
                                    <p class="h5-para black-text m0">Banner</p>
                                </div>
                                <div class="col 12 m6 right-align">
                                    <a href="<?php echo base_url('banner/add')  ?>" class="waves-effect waves-light btn green darken-4 white-text hoverable "><i class="fas fa-plus left"></i> ADD Banner</a>
                                </div>
                            </div>
                                    ...
                                    <?php if (!empty($result)) { $count = 0; foreach ($result as $key => $value) { $count = $count+1; ?>
                                      ...
                                      <td ><?php echo (!empty($result))?$count:'---'  ?></td>
                                            ...
                                            <td class="action-btn  center-align">
                                              ...
                                              <!-- view user -->
                                              <!-- delete user -->
                                                <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url('banner/delete/'.$value->id.'') ?> " class="red hoverable delete-btn"><i class="fas fa-trash  "></i></a>
                                                <!-- delete user -->
                                            </td>
