                    ...
                    <div class="card z-depth-2">
                        <div class="card-content">
                            <div >
                                ...
                                <form method="post"  action="<?php echo base_url()?>update-password" style="overflow: hidden;" id="reset-form">
                                <div class="input-field col s12">
                                    <input type="email" id="remail" class="validate"  required name="remail">
